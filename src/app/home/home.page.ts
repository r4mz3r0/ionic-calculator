...
export class HomePage {
  ...
  constructor(public historyStorage : HistoryService, private admobFreeService: AdmobfreeService){// public admob: AdMob) {
  ...
  traverseHistory() {
    console.log(this.historyStorage.getStorage());
